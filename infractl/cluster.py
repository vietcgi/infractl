import typer
from infractl.modules.install_rke2 import create_cluster
...
def create_command(
    ...
    create_cluster(region=region, env=env, name=name, skip_argocd=skip_argocd, install_flux=install_flux, force_refresh_ips=force_refresh_ips)
